  ...
  return createPortal(
    <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/50 p-5" role="presentation">
      <section
        ...
        className="flex max-h-[80vh] w-full max-w-2xl flex-col gap-4 rounded-lg border border-border-secondary bg-bg-card p-5 text-text-base shadow-active"
      >
        ...
        {options.length > 0 ? (
          ...
          >
            {options.map((asset) => (
              <button
                ...
                className={compact ? 'flex items-center gap-3 rounded-lg border border-border-input bg-bg-input p-2 text-left transition hover:border-border-primary' : 'flex flex-col gap-2 rounded-lg border border-border-input bg-bg-input p-2 text-left transition hover:border-border-primary'}
                onClick={() => onSelect(asset)}
              >
                <div className={compact ? 'flex h-12 w-16 shrink-0 items-center justify-center overflow-hidden rounded-md border border-border-secondary bg-bg-card' : 'flex aspect-video items-center justify-center overflow-hidden rounded-md border border-border-secondary bg-bg-card'}>
                  {mediaType === 'image' ? (
          ...
          <div className="flex min-h-36 flex-col items-center justify-center gap-2 rounded-lg border border-dashed border-border-input text-text-muted">

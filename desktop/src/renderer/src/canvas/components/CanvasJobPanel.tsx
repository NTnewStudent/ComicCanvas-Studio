  ...
  return (
    ...
    >
      <div className="flex h-12 shrink-0 items-center justify-between border-b border-border-secondary px-3">
        <div>
          <h2 className="text-[14px] font-bold text-text-base">运行任务</h2>
          <p className="text-[11px] text-text-muted">最近 8 个本地任务</p>
        </div>
      ...
      <div className="min-h-0 flex-1 overflow-y-auto p-2">
        ...
        {!error && jobs.length > 0 && (
          <div className="space-y-2">
            {jobs.map((job) => (
              <article key={job.id} className="rounded-lg border border-border-secondary bg-bg-card px-3 py-2">

...
import { IconWorld, IconRobot, IconTool, IconDatabase, IconPalette, IconSparkles } from '@tabler/icons-react'
...
type SettingsTab = 'gateway' | 'agent' | 'tool' | 'skill' | 'style' | 'storage'

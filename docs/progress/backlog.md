...
**当前焦点** → M2 REQ-026~029（节点画幅 / inline 改名 / 持久化 / 零轮询）
**下一步** → 按 `specs/milestone-execution-plan/tasks.md` 从 M2 第 20 项 node sizing and inline rename primitives 开始，并参考 `hjwall/pc-client` 的画布实现改写到当前 React/Electron 架构。

...
**当前焦点** → M2 REQ-025~029（prompt 预览 / 持久化 / 零轮询）
**下一步** → 按 `specs/milestone-execution-plan/tasks.md` 从 M2 第 19 项 Connected Inputs Panel 开始，并参考 `hjwall/pc-client` 的画布实现改写到当前 React/Electron 架构。

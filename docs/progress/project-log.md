...
| :--- | :--- | :--- | :--- |
| Phase 0 | 1-3 | Not started | Capability inventory, evidence audit, and the human desktop review gate remain open. `/projects` and `/canvas` checkpoints belong in the reviewer checklist. |

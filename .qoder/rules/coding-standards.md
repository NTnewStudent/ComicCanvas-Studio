---
description: "General coding standards for TypeScript, architecture, naming conventions and mandatory annotations"
alwaysApply: true
---
...
- **工具（Tool）自描述**：每个 Tool 实现统一接口（schema / 权限 / 执行 / 渲染），见 `#tool-contracts` steering。

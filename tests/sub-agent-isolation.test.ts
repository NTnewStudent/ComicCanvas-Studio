...
const parentGraph: CanvasGraphSnapshot = {
  nodes: [
...
async function withWorkflowRepository(run: (dependencies: ReturnType<typeof createWorkflowRepository>) => Promise<void> | void): Promise<void> {

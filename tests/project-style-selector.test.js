...
import { ProjectStyleSelector } from '../desktop/src/renderer/src/canvas/components/ProjectStyleSelector';
const inkStyle = {
    id: 'style-ink',
    code: 'ink',
    name: 'Industrial Ink',
...
describe('REQ-094 project default style selector', () => {
    it('loads the current workflow default style and persists a changed selection', async () => {
        ...
        render(_jsx(ProjectStyleSelector, { workflowId: "workflow-1", api: api }));

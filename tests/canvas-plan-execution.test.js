...
describe('canvas-plan-execution controller', () => {
    it('maps videoRun failures to canvas.generateVideo node patches', () => {
        ...
        const tickets = [
            { jobId: 'job-image-1', nodeId: 'plan-node-image-a', status: 'pending', createdAt: 1_783_700_000_000 },
            { jobId: 'job-video-1', nodeId: 'plan-node-video-a', status: 'pending', createdAt: 1_783_700_000_001 }
        ];

...
describe('Task 38 image inpaint gate parity', () => {
    it('shows a clear unavailable gate instead of fake inpaint execution', () => {
        const onClose = vi.fn();
        render(_jsx(ImageInpaintModal, { label: "Hero Image", assetId: "asset-hero", safeUrl: "cc-asset://asset/asset-hero", onClose: onClose }));
    ...
    it('opens the unavailable inpaint gate from ImageNode configuration', () => {
        render(_jsx(ReactFlowProvider, { children: _jsx(ImageNode, { id: "image-1", data: imageData, selected: true, assetSafeUrl: "cc-asset://asset/asset-hero" }) }));

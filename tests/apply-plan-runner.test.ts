...
import { createPlanRunner, type PlanRunnerStep } from '../desktop/src/renderer/src/canvas/lib/plan-runner'
...
describe('M4 applyPlan and PlanRunner', () => {
  ...
  it('runs plan steps serially and finishes only after the third terminal success', () => {
    const launched: Array<{ step: PlanRunnerStep; index: number }> = []

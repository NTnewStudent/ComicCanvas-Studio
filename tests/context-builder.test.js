...
import { buildAgentContext, lexicalRetrieve } from '../desktop/src/main/knowledge/context-builder';
...
describe('ContextBuilderService', () => {
    ...
    it('includes recent messages respecting token budget', () => {
        const messages = [
            { id: 'm1', role: 'user', content: 'I want a wuxia character', createdAt: 1 },
            { id: 'm2', role: 'assistant', content: 'What style do you prefer?', createdAt: 2 }
        ];
        const result = buildAgentContext({
            ...baseInput,

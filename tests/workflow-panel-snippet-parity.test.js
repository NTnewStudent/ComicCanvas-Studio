...
describe('Task 48 WorkflowPanel snippet parity', () => {
    it('renders snippet scope metadata, detail fragment, and owned delete action', () => {
        ...
        render(_jsx(WorkflowPanel, { open: true, snippets: [snippet, { ...snippet, id: 'snippet-public', name: 'Public camera rig', scope: 'public', ownerId: 'team', ownedByCurrentUser: false }], selectedSnippetId: "snippet-rain", onSelectSnippet: onSelectSnippet, onInsertSnippet: vi.fn(), onSaveSnippet: vi.fn(), onDeleteSnippet: onDeleteSnippet, onClose: vi.fn() }));

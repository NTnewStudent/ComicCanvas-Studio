...
import { createStorageConfigRepository } from '../desktop/src/main/db/repositories/storage.repo';
...
async function loadStorageHandler() {
    vi.resetModules();
    return import('../desktop/src/main/ipc/storage.handler');
}
function createStorageContext(tempDirs, openDbs) {

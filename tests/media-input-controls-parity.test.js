...
describe('Task 39 node asset picker and media input controls parity', () => {
    ...
    it('selects, clears, and gates external URL binding from shared media controls', () => {
        const onSelect = vi.fn();
        const onClear = vi.fn();
        render(_jsx(MediaInputControls, { mediaType: "image", label: "\u4E3B\u56FE\u7D20\u6750", selectedAssetId: "asset-image-a", selectedSafeUrl: "cc-asset://asset/asset-image-a", options: [{ assetId: 'asset-image-b', label: 'Rain alley', safeUrl: 'cc-asset://asset/asset-image-b' }], compact: true, onSelect: onSelect, onClear: onClear }));
    ...
    it('binds and clears audio assets from AudioNode through the shared media controls', () => {
        ...
        render(_jsx(ReactFlowProvider, { children: _jsx(AudioNode, { id: "audio-1", selected: true, data: {
                    label: 'Theme',
                    ...
                    status: 'idle',
                    referenceRole: 'music'
                }, assetOptions: audioOptions, onChange: onChange }) }));

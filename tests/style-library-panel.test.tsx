...
import { StyleLibraryPanel, type StyleLibraryPanelApi } from '../desktop/src/renderer/src/canvas/components/StyleLibraryPanel'
...
const disabledStyle: StylePresetView = {
  ...inkStyle,
  id: 'style-disabled',
  code: 'old',
  name: 'Retired Neon',
...
function createApi(overrides: Partial<StyleLibraryPanelApi> = {}): StyleLibraryPanelApi {
  return {
...
describe('Task 50 canvas style library panel parity', () => {
  it('lists style presets with cover, tags, current default, and disabled markers', async () => {
    ...
    render(<StyleLibraryPanel open workflowId="workflow-1" onClose={vi.fn()} api={api} />)

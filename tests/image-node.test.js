...
function renderImageNode(overrides = {}) {
    const onChange = vi.fn();
    const data = { ...defaultData, ...overrides.data };
    render(_jsx(ReactFlowProvider, { children: _jsx(ImageNode, { ...overrides, id: overrides.id ?? 'image-1', data: data, assetOptions: overrides.assetOptions ?? [

...
- [x] 1. Register this foundation spec in `docs/progress/backlog.md`.
  - Verify: backlog links `specs/core-platform-foundation/tasks.md`.
  - Covers: R1.

- [x] 2. Treat root `specs/` as the canonical spec archive.
...
- [x] 3. Keep `.claude/` and `.codex/` as tool/runtime layers only.
  - Verify: agent and skill instructions point product specs to `specs/`.
  - Covers: R1.

## Phase B - API Contract Documents

- [x] 4. Create `docs/api-contracts/canvas-plan.md`.
...
- [x] 5. Create `docs/api-contracts/jobs.md`.
...
- [x] 6. Create `docs/api-contracts/assets-files.md`.
...
- [x] 7. Create `docs/api-contracts/gateway-providers.md`.
...
- [x] 8. Create `docs/api-contracts/tools-plugins.md`.
...
- [x] 9. Create `docs/api-contracts/agents.md`.
...
- [x] 10. Create `docs/api-contracts/skills.md`.
...
- [x] 11. Create `docs/api-contracts/knowledge-context.md`.
...
- [x] 12. Create `docs/api-contracts/audit-observability.md`.
...
- [x] 17. Extend `shared/ipc.ts` with domain/action channel schemas.
...
- [x] 18. Draft DB schema for jobs, assets, asset folders, references, gateways, tools, agents, skills, knowledge, context packs, and audits.
  - Verify: schema review maps every table to a requirement in `design.md`.
  - Covers: R3-R10.

- [x] 19. Define repository ownership boundaries under `desktop/src/main/db/repositories/`.
  - Verify: no service design reaches into raw SQL/Drizzle outside repositories.
  - Covers: R1, R10.

- [x] 20. Define migration policy.
...
- [x] 21. Plan JobRuntime implementation.
...
- [x] 22. Plan AssetService and local file library implementation.
...
- [x] 23. Plan GatewayRegistry implementation.
...
- [x] 28. Define settings/admin UI requirements for gateways, tools, plugins, agents, skills, knowledge, and local file library.
  - Verify: each settings surface maps to an API contract and permission model.
  - Covers: R4-R10.

- [x] 29. Define initial built-in tool list.
...
- [x] 30. Define initial built-in skill list.
...
- [x] 31. Define default agent lineup and handoff rules.
...
- [x] 33. Run no-demo acceptance review.
...
- [x] 34. Only after tasks 1-33 are accepted, open implementation plans for M1/M2.
